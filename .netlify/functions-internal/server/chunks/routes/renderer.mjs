...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1, maximum-scale=1"},{"charset":"utf-16"}],"link":[{"rel":"stylesheet","href":"css/all.min.css"},{"rel":"stylesheet","href":"css/tooplate-style.css"},{"rel":"stylesheet","href":"css/annachiara-custom.css"}],"style":[],"script":[{"src":"https://www.googletagmanager.com/gtag/js?id=G-CBE1SBBVC4","async":true},{"innerHTML":"\n            window.dataLayer = window.dataLayer || [];\n            function gtag(){dataLayer.push(arguments);}\n            gtag('js', new Date());\n            gtag('config', 'G-CBE1SBBVC4');\n          ","type":"text/javascript"}],"noscript":[],"charset":"utf-16","viewport":"width=device-width, initial-scale=1, maximum-scale=1"};
