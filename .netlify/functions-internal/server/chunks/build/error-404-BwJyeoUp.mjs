...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "antialiased bg-white dark:bg-black dark:text-white font-sans grid min-h-screen overflow-hidden place-content-center text-black" }, _attrs))} data-v-e9759bff><div class="fixed left-0 right-0 spotlight z-10" data-v-e9759bff></div><div class="max-w-520px text-center z-20" data-v-e9759bff><h1 class="font-medium mb-8 sm:text-10xl text-8xl" data-v-e9759bff>${ssrInterpolate(__props.status)}</h1><p class="font-light leading-tight mb-16 px-8 sm:px-0 sm:text-4xl text-xl" data-v-e9759bff>${ssrInterpolate(__props.description)}</p><div class="flex items-center justify-center w-full" data-v-e9759bff>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.21.8_@parcel+watcher@2.5.6_@types+node@26.1.0_@vue+compiler-sfc@3.5.39_cac@6.7.1_b7100f3dd4dc5b370276f956ba828dd9/node_modules/nuxt/dist/app/components/error-404.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const error404 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-e9759bff"]]);

export { error404 as default };
//# sourceMappingURL=error-404-BwJyeoUp.mjs.map
